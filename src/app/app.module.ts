...
import { JwtInterceptor, httpInterceptorProviders } from './security/JwtInterceptor';
...
@NgModule({
  ...
  imports: [
    ...
    MatToolbarModule, MatButtonModule, MatSidenavModule, MatIconModule, MatListModule, MatMenuModule, MatDialogModule, MatProgressBarModule
    ...
    MatRadioModule, MatAutocompleteModule, ReactiveFormsModule, MatTooltipModule, MatPaginatorModule, MatDatepickerModule, MatExpansionModule
    , MatSortModule, _MatSlideToggleRequiredValidatorModule, MatSnackBarModule, MatStepperModule, MatTableExporterModule, MatProgressSpinnerModule
  ],

  providers: [NetworkCallService, TokenStorageService, httpInterceptorProviders
  ],
