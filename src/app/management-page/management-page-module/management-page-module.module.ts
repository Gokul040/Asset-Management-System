...
import { JwtInterceptor, httpInterceptorProviders } from 'src/app/security/JwtInterceptor';
...
@NgModule({
  ...
  imports: [
    ...
    MatExpansionModule, MatCardModule, FlexLayoutModule, MatTableModule, MatSortModule, MatTableExporterModule, MatProgressSpinnerModule, MatProgressBarModule
    , _MatSlideToggleRequiredValidatorModule, MatStepperModule, MatInputModule],
  exports:
    [
    ],
  providers: [NetworkCallService, TokenStorageService
  ],
})
