...
export class NetworkCallService {
  ...
  getEmployeeExport() {
    return this.httpClient.get(`${this.URLRegisteration}/employee/get-all-employee`);
  }
  ...
  getAssetDetails1(): Observable<assetDetails[]> {
    return this.httpClient.get<assetDetails[]>(`${this.URLRegisteration}/asset-details/get-all-asset-details`);
  }
